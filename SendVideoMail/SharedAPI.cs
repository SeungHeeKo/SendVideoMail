...
namespace SendVideoMail
{
    class SharedAPI
    {
        ...
        public void GetShareFolderFile(string resultFolder)
        {
            string strFolder = @"\\SHKO\sh_공유폴더";
            ...
            if(files != null)
            {
                ...
                {
                    System.Diagnostics.Debug.Write(file.FullName);
                    string strDest = resultFolder + file.Name;
                    //MessageBox.Show(file.FullName);
                    System.IO.File.Copy(@file.FullName, @strDest, true);
                }
            }
        }
